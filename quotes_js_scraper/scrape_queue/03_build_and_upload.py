...
GOOGLE_MAPS_API_KEY = os.environ.get("GOOGLE_MAPS_API_KEY")  # <- prefer env var
...
def main():
    ...
    for raw in tqdm(data, desc="Uploading playlists"):
        ...
        for idx, item in enumerate(items, start=1):
            ...
            photo_refs = (item.get("photo_refs") or [])[:10]
            if not photo_refs and det:
                photo_refs = (det.get("photo_refs") or [])[:10]
