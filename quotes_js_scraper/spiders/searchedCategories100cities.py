...
class SearchedCategoriesSpider(scrapy.Spider):
    ...
    cities_manual = [
        {"name": "Kashmir", "id": "86838", "url": f"https://wanderlog.com/searchedCategories/86838"},
        {"name": "Gangtok", "id": "503", "url": f"https://wanderlog.com/searchedCategories/503"},
        {"name": "Ladakh", "id": "86858", "url": f"https://wanderlog.com/searchedCategories/86858"},
        {"name": "Udiapur", "id": "91", "url": f"https://wanderlog.com/searchedCategories/91"},
        {"name": "Andaman and Nicobar Islands", "id": "86944", "url": f"https://wanderlog.com/searchedCategories/86944"},
        {"name": "Manali", "id": "146271", "url": f"https://wanderlog.com/searchedCategories/146271"},
        {"name": "Agra", "id": "60", "url": f"https://wanderlog.com/searchedCategories/60"},
        {"name": "Shillong", "id": "728", "url": f"https://wanderlog.com/searchedCategories/728"},
        {"name": "Darjeeling", "id": "349", "url": f"https://wanderlog.com/searchedCategories/349"},
        {"name": "Amritsar", "id": "384", "url": f"https://wanderlog.com/searchedCategories/384"},
        {"name": "Goa", "id": "86853", "url": f"https://wanderlog.com/searchedCategories/86853"},
    ...
    def extract_place_data(self, place, index):
        ...
        return {
            # Add Latitude, Longitude, g_image_urls & reviews
            'index': index,
            'id': str(place.get('id')),
            'name': place.get('name'),
