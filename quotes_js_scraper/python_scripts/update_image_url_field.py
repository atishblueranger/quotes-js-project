...
"""
Script to upload images from local to Firebase Storage and update Firestore 'playlists' collection.
For a given city_id, it processes all playlist folders in the 'Categories Search' folder, uploads the image files to Firebase Storage,
and updates the 'imageUrl' field in the matching Firestore document.
"""
